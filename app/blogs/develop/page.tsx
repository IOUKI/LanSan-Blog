        ...
        {blogs.map(blog => (
          <Link href={'/blogs/develop/' + blog.slug} passHref key={blog.slug} className="group dark:focus:outline-none">
            ...
            <div className="relative pt-[50%] sm:pt-[70%] rounded-xl overflow-hidden">
              <Image className="size-full absolute top-0 start-0 object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out rounded-xl" src={"/blogImages/" + blog.meta.image} alt="Image Description" />
            </div>
