    ...
    <footer className="w-full bg-white dark:bg-gray-800">
      <div className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-white dark:bg-gray-800">
        <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-5 text-center">
          <div>
            <a className="flex-none text-xl font-semibold text-black dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#" aria-label="Lan">Lan</a>
          </div>
